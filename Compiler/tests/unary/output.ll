...
"Func entry":
  ...
  %print_float = call float @print_float(float %result5)
  ...
  %negflo20 = fneg float %m19
  %negflo21 = fneg float %negflo20
  %"+22" = sitofp i32 %n18 to float
  %faddtmp23 = fadd float %"+22", %negflo21
  store float %faddtmp23, ptr %result, align 4
  %result24 = load float, ptr %result, align 4
  %print_float25 = call float @print_float(float %result24)
  ...
  %negflo31 = fneg float %m30
  %"+32" = sitofp i32 %negint to float
  %faddtmp33 = fadd float %"+32", %negflo31
  store float %faddtmp33, ptr %result, align 4
  %result34 = load float, ptr %result, align 4
  %print_float35 = call float @print_float(float %result34)
